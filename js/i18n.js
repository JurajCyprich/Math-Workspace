...
(function () {
  ...
  var UI = {
    ...
    'btn.draw': ['Nakresliť symbol', 'Draw a symbol'],
    ...
    'btn.note.t': ['Písanie rukou (Ctrl+H)', 'Handwriting (Ctrl+H)'],
    'btn.note': ['Písanie rukou', 'Handwriting'],
    'note.title': ['Písanie rukou', 'Handwriting'],
    'note.note': ['Píš na linajky. Po krátkej pauze sa text prepíše dole.',
      'Write on the lines. After a short pause the text appears below.'],
    'note.commit': ['Prepísať', 'Convert'],
    'note.clearInk': ['Vymazať', 'Erase'],
    'note.space': ['Medzera', 'Space'],
    'note.enter': ['Nový riadok', 'New line'],
    'note.back': ['Zmazať znak', 'Delete character'],
    ...
    'note.read': ['prečítané: {n}', 'read: {n}'],
    'note.preparing': ['pripravujem písmená…', 'preparing letters…'],
    'note.ready': ['{n} znakov pripravených', '{n} characters ready'],
    'note.nothing': ['Nič som neprečítal. Skús písať väčšie a na linajky.',
      'Nothing was read. Try writing larger and on the lines.'],
    ...
    'help.symbols.4': ['<b>Písanie rukou</b> – píš na linajky celé slová, dole sa prepíšu na text',
      '<b>Handwriting</b> – write whole words on the lines, they turn into text below'],
    ...
    'help.keys.5': ['<code>Ctrl+E</code> kalkulačka, <code>Ctrl+H</code> písanie rukou',
      '<code>Ctrl+E</code> calculator, <code>Ctrl+H</code> handwriting'],
